...
export const api = {
  ...
  // Server re-prices lines from item_sku/quantity - only send those two fields
  async createRestockOrder(lines) {
    const response = await axios.post(`${API_BASE_URL}/restock-orders`, { lines })
    return response.data
  }
}
